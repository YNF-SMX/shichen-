 ...
 * @LastEditTime: 2020-05-27 17:02:30
...
typedef enum
{
    AX_ERR_AX_ALM = (1 << 0),		//轴报警 0x01
    AX_ERR_AX_TMOUT = (1 << 1),		//超时（回原点）0x10
    AX_ERR_UP_LIM_H = (1 << 8),		//硬上限位 0x1000
    AX_ERR_UP_LIM_S = (1 << 9),		//软上限位 0x1001
    AX_ERR_DW_LIM_H = (1 << 12),		//硬下限位 0x1100
    AX_ERR_DW_LIM_S = (1 << 13),		//软下限位 0x1101
} AxErrBitTp;
